...
using OSMD.Models;
using OSMD.Models.AccountViewModels;
using OSMD.Services;
...
namespace OSMD.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Login(LoginViewModel model, string returnUrl = null)
        {
            ...
            {
                var user = await _userManager.FindByNameAsync(model.Email);   ///ПОДТВЕРЖДЕНИЕ ПО ЕМЕИЛ
                if (user != null)
                {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    var callbackUrl = Url.Action(
                        "ConfirmEmail",
                        "Account",
                        new { userId = user.Id, code = code },      //// РЕГИСТРАЦИЯ
